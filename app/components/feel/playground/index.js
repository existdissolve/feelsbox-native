...
import {CategoryPicker, Container, Dialog, SnackbarContext, Spacer, Toolbar} from '-/components/shared';
import {
    ...
    return (
        <Container>
            <Toolbar>
                ...
                <IconButton icon="image-album" color={isThumb ? theme.colors.accent : undefined} onPress={onSetThumbPress} />
