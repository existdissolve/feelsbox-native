            ...
            {!loading &&
                <ScrollView>
                    {messages.map((item, idx) => {
                        ...
                        const feel = () => <Feel feel={feelSnapshot} wrapperStyle={{flex: .25}} pixelSize={4} />;
                        const Content = () => (
                            <View>
                                <Text>
                                    {name}{'\n'}
                        ...
                        return (
                            <Fragment key={_id}>
                                <List.Item title={message} right={Content} left={feel} titleNumberOfLines={0} titleStyle={{flex: 2, marginRight: 15}} />
