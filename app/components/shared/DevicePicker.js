...
export default props => {
    ...
    const toggle = (_id, checked, collection, setter) => {
    ...
    const toggleGroup = (_id, checked) => {
        toggle(_id, checked, selectedDeviceGroups, setSelectedDeviceGroups);
    };

    const toggleDevice = (_id, checked) => {
        toggle(_id, checked, selectedDevices, setSelectedDevices);
    };
